...
public class InvoiceFrame extends JFrame {
    ...
    private JPanel createContent() {
        ...
        javax.swing.table.JTableHeader invoiceHeader = table.getTableHeader();
        invoiceHeader.setFont(new Font("Segoe UI", Font.BOLD, 12));
        invoiceHeader.setBackground(new Color(35, 35, 45));
        invoiceHeader.setForeground(UIConstants.TEXT_COLOR);
        invoiceHeader.setReorderingAllowed(false);
        ...
        public java.awt.Component getTableCellRendererComponent(JTable table, Object value,
            ...
            if (isSelected) {
                ...
                setForeground(switch (status) {
                    ...
                    case "UNPAID" -> UIConstants.WARNING_COLOR;
